...
#      	time.sleep(1)
	...
	if int(volume_norm) >= 0 and int(volume_norm) < 10:
    	...
    	if int(volume_norm) >= 20 and int(volume_norm) < 50:
       		strip.setPixelColor(0, Color(70, 180, 0))
       		strip.setPixelColor(1, Color(70, 180, 0))
       		strip.setPixelColor(2, Color(70, 180, 0))
       		strip.setPixelColor(3, Color(70, 180, 0))
       		strip.setPixelColor(4, Color(70, 180, 0))
       		strip.setPixelColor(5, Color(70, 180, 0))
       		strip.setPixelColor(6, Color(70, 180, 0))
       		strip.setPixelColor(7, Color(70, 180, 0))
       		strip.setPixelColor(8, Color(70, 180, 0))
       		strip.setPixelColor(9, Color(70, 180, 0))
       		strip.setPixelColor(10, Color(70, 180, 0))
       		strip.setPixelColor(11, Color(70, 180, 0))
       		strip.setPixelColor(12, Color(70, 180, 0))
       		strip.setPixelColor(13, Color(70, 180, 0))
       		strip.setPixelColor(14, Color(70, 180, 0))
       		strip.setPixelColor(15, Color(70, 180, 0))
       		strip.setPixelColor(16, Color(70, 180, 0))
       		strip.setPixelColor(17, Color(70, 180, 0))
       		strip.setPixelColor(18, Color(70, 180, 0))
       		strip.setPixelColor(19, Color(70, 180, 0))
       		strip.setPixelColor(20, Color(70, 180, 0))
       		strip.setPixelColor(21, Color(70, 180, 0))
       		strip.setPixelColor(22, Color(70, 180, 0))
       		strip.setPixelColor(23, Color(70, 180, 0))
       		strip.setPixelColor(24, Color(70, 180, 0))
       		strip.setPixelColor(25, Color(70, 180, 0))
       		strip.setPixelColor(26, Color(70, 180, 0))
       		strip.setPixelColor(27, Color(70, 180, 0))
       		strip.setPixelColor(28, Color(70, 180, 0))
       		strip.setPixelColor(29, Color(70, 180, 0))
       		strip.setPixelColor(30, Color(70, 180, 0))
       		strip.setPixelColor(31, Color(70, 180, 0))
       		strip.show()
